...
#define KIBI(k)     ((uint64) 1024 * (k))
#define MEBI(m)     ((uint64) 1024 * 1024 * (m))
#define GIBI(g)     ((uint64) 1024 * 1024 * 1024 * (g))
...
#define TYP_M5I3360_X16             0x000A3360      // 1x10G 12bit high bandwidth
#define TYP_M5I3367_X16             0x000A3367      // 1x10G 2x5G 12bit high bandwidth
#define TYP_M5I3380_X16             0x000A3380l     // customer specific variant
#define TYP_M5I3387_X16             0x000A3387l     // customer specific variant
...
// ----- M5i.63xx-x4 (16 bit D/A) -----
#define TYP_M5I63XX_X16             0x000A6300      // generic
#define TYP_M5I6320_X16             0x000A6320      // 1 ch @ 3.2 GS/s
#define TYP_M5I6321_X16             0x000A6321      // 2 ch @ 3.2 GS/s
#define TYP_M5I6350_X16             0x000A6350      // 1 ch @ 10 GS/s
#define TYP_M5I6357_X16             0x000A6357      // 1 ch @ 10 GS/s, 2 ch @ 5 GS/s
#define TYP_M5I6360_X16             0x000A6360      // 1 ch @ 10 GS/s high bandwidth
#define TYP_M5I6367_X16             0x000A6367      // 1 ch @ 10 GS/s, 2 ch @ 5 GS/s high bandwidth
...
// ----- M4i.96xx-x8 (16 bit D/A) -----
// ----- DDS-only types -----
#define TYP_M4I96XX_X8              0x00079600      // generic
#define TYP_M4I9620_X8              0x00079620      // 1 ch @  625 MS/s
#define TYP_M4I9621_X8              0x00079621      // 2 ch @  625 MS/s
#define TYP_M4I9622_X8              0x00079622      // 4 ch @  625 MS/s

// ----- M4x.96xx-x4 (16 bit D/A) -----
// ----- DDS-only types -----
#define TYP_M4X96XX_X4              0x00089600      // generic
#define TYP_M4X9620_X4              0x00089620      // 1 ch @  625 MS/s
#define TYP_M4X9621_X4              0x00089621      // 2 ch @  625 MS/s
#define TYP_M4X9622_X4              0x00089622      // 4 ch @  625 MS/s
...
#define SPCM_FEAT_EXTFW_DDS         0x00000010        // DDS available
#define SPCM_FEAT_EXTFW_DDS20       0x00000010        // DDS with 20 tones available
#define SPCM_FEAT_EXTFW_DDS50       0x00000020        // DDS with 50 tones available
#define SPCM_FEAT_EXTFW_AWG         0x00000040        // AWG features available
#define SPCM_FEAT_EXTFW_EVALUATION  0x80000000        // used in combination with other flags to check for evaluation versions
...
#define SPC_REGISTER_LIST           120l
#define SPC_WRITE_TO_LOG            121l
...
#define     SPCM_AO_DIFF            0x00000004  // differential mode available (combining two channels)
...
#define     SPCM_AO_TRUEDIFF        0x00000200  // differential output on dedicated +/- connectors
#define     SPCM_AO_AUTOCALOFFS     0x00000400  // automatic offset calibration in hardware
#define     SPCM_AO_AUTOCALGAIN     0x00000800  // automatic gain calibration in hardware
...
#define     SPC_REP_STD_DDS             0x04000000  // DDS replay
...
#define     SPCM_CKFEAT_PROGSAMPLEDELAY 0x00000800
#define     SPCM_CKFEAT_PROGSAMPLEEDGE  0x00001000
...
#define SPC_TIMESTAMP_SIZE          47011l
...
#define     SPCM_XMODE_DDS               0x00000004  // same as SPCM_XMODE_DIGIN because that one is used for inputs only, and the other is output only
...
#define     SPCM_DC_12BIT_TO_12BITPACKED    0x00001000
...
// ***** constants to use with the _ENABLEOUT registers *****
#define SPC_AVAILENABLEOUT          206028
#define     SPCM_ENABLE_OUT_OFF         0x0
#define     SPCM_ENABLE_OUT_PLUS        0x1
#define     SPCM_ENABLE_OUT_MINUS       0x2
...
#define SPC_NUM_FW_CONFIGS          210100l
#define SPC_FW_CONFIG_READIDX       210101l
#define SPC_FW_CONFIG_DESCRIPTION   210102l
#define SPC_FW_CONFIG_REQ_EXTFEAT   210103l
#define SPC_AVAIL_FW_LICENSE        210104l
...
#define     NETBOX_FAMILY_33        0x00330000
...
#define     NETBOX_FAMILY_63        0x00630000
...
#define     NETBOX_FAMILY_96        0x00960000
...
#define     NETBOX_CHANNELS_1       0x00000001
...
#define SPC_MON_V_MOD_11            500107l
#define SPC_MON_V_MOD_12            500108l
#define SPC_MON_V_MOD_13            500109l
#define SPC_MON_V_MOD_14            500110l
#define SPC_MON_V_MOD_15            500111l
#define SPC_MON_V_MOD_16            500112l

#define SPC_MON_TK_MODULE_3         500113l
#define SPC_MON_TC_MODULE_3         500114l
#define SPC_MON_TF_MODULE_3         500115l
...
#define     SPCM_MON_T_MODULE_3         0x2000000000000000ULL
...
#define     SPCM_MON_V_MOD_11           0x0000000000000800ULL
#define     SPCM_MON_V_MOD_12           0x0000000000001000ULL
#define     SPCM_MON_V_MOD_13           0x0000000000002000ULL
#define     SPCM_MON_V_MOD_14           0x0000000000004000ULL
#define     SPCM_MON_V_MOD_15           0x0000000000008000ULL
#define     SPCM_MON_V_MOD_16           0x0000000000010000ULL
...
#define SPC_NUM_XIO_LINES           600400l
...
#define SPC_XIO_NUM_PULSEGEN                602013l

// DDS stuff
#define SPC_DDS_CORE0_FREQ                  603000l
#define SPC_DDS_CORE1_FREQ                  603001l
#define SPC_DDS_CORE2_FREQ                  603002l
#define SPC_DDS_CORE3_FREQ                  603003l
#define SPC_DDS_CORE4_FREQ                  603004l
#define SPC_DDS_CORE5_FREQ                  603005l
#define SPC_DDS_CORE6_FREQ                  603006l
#define SPC_DDS_CORE7_FREQ                  603007l
#define SPC_DDS_CORE8_FREQ                  603008l
#define SPC_DDS_CORE9_FREQ                  603009l
#define SPC_DDS_CORE10_FREQ                 603010l
#define SPC_DDS_CORE11_FREQ                 603011l
#define SPC_DDS_CORE12_FREQ                 603012l
#define SPC_DDS_CORE13_FREQ                 603013l
#define SPC_DDS_CORE14_FREQ                 603014l
#define SPC_DDS_CORE15_FREQ                 603015l
#define SPC_DDS_CORE16_FREQ                 603016l
#define SPC_DDS_CORE17_FREQ                 603017l
#define SPC_DDS_CORE18_FREQ                 603018l
#define SPC_DDS_CORE19_FREQ                 603019l
#define SPC_DDS_CORE20_FREQ                 603020l
#define SPC_DDS_CORE21_FREQ                 603021l
#define SPC_DDS_CORE22_FREQ                 603022l
#define SPC_DDS_CORE23_FREQ                 603023l
#define SPC_DDS_CORE24_FREQ                 603024l
#define SPC_DDS_CORE25_FREQ                 603025l
#define SPC_DDS_CORE26_FREQ                 603026l
#define SPC_DDS_CORE27_FREQ                 603027l
#define SPC_DDS_CORE28_FREQ                 603028l
#define SPC_DDS_CORE29_FREQ                 603029l
#define SPC_DDS_CORE30_FREQ                 603030l
#define SPC_DDS_CORE31_FREQ                 603031l
#define SPC_DDS_CORE32_FREQ                 603032l
#define SPC_DDS_CORE33_FREQ                 603033l
#define SPC_DDS_CORE34_FREQ                 603034l
#define SPC_DDS_CORE35_FREQ                 603035l
#define SPC_DDS_CORE36_FREQ                 603036l
#define SPC_DDS_CORE37_FREQ                 603037l
#define SPC_DDS_CORE38_FREQ                 603038l
#define SPC_DDS_CORE39_FREQ                 603039l
#define SPC_DDS_CORE40_FREQ                 603040l
#define SPC_DDS_CORE41_FREQ                 603041l
#define SPC_DDS_CORE42_FREQ                 603042l
#define SPC_DDS_CORE43_FREQ                 603043l
#define SPC_DDS_CORE44_FREQ                 603044l
#define SPC_DDS_CORE45_FREQ                 603045l
#define SPC_DDS_CORE46_FREQ                 603046l
#define SPC_DDS_CORE47_FREQ                 603047l
#define SPC_DDS_CORE48_FREQ                 603048l
#define SPC_DDS_CORE49_FREQ                 603049l
#define SPC_DDS_CORE50_FREQ                 603050l
#define SPC_DDS_CORE51_FREQ                 603051l
#define SPC_DDS_CORE52_FREQ                 603052l
#define SPC_DDS_CORE53_FREQ                 603053l
#define SPC_DDS_CORE54_FREQ                 603054l
#define SPC_DDS_CORE55_FREQ                 603055l
#define SPC_DDS_CORE56_FREQ                 603056l
#define SPC_DDS_CORE57_FREQ                 603057l
#define SPC_DDS_CORE58_FREQ                 603058l
#define SPC_DDS_CORE59_FREQ                 603059l
#define SPC_DDS_CORE60_FREQ                 603060l
#define SPC_DDS_CORE61_FREQ                 603061l
#define SPC_DDS_CORE62_FREQ                 603062l
#define SPC_DDS_CORE63_FREQ                 603063l

#define SPC_DDS_CORE0_FREQ_SLOPE            604000l
#define SPC_DDS_CORE1_FREQ_SLOPE            604001l
#define SPC_DDS_CORE2_FREQ_SLOPE            604002l
#define SPC_DDS_CORE3_FREQ_SLOPE            604003l
#define SPC_DDS_CORE4_FREQ_SLOPE            604004l
#define SPC_DDS_CORE5_FREQ_SLOPE            604005l
#define SPC_DDS_CORE6_FREQ_SLOPE            604006l
#define SPC_DDS_CORE7_FREQ_SLOPE            604007l
#define SPC_DDS_CORE8_FREQ_SLOPE            604008l
#define SPC_DDS_CORE9_FREQ_SLOPE            604009l
#define SPC_DDS_CORE10_FREQ_SLOPE           604010l
#define SPC_DDS_CORE11_FREQ_SLOPE           604011l
#define SPC_DDS_CORE12_FREQ_SLOPE           604012l
#define SPC_DDS_CORE13_FREQ_SLOPE           604013l
#define SPC_DDS_CORE14_FREQ_SLOPE           604014l
#define SPC_DDS_CORE15_FREQ_SLOPE           604015l
#define SPC_DDS_CORE16_FREQ_SLOPE           604016l
#define SPC_DDS_CORE17_FREQ_SLOPE           604017l
#define SPC_DDS_CORE18_FREQ_SLOPE           604018l
#define SPC_DDS_CORE19_FREQ_SLOPE           604019l
#define SPC_DDS_CORE20_FREQ_SLOPE           604020l
#define SPC_DDS_CORE21_FREQ_SLOPE           604021l
#define SPC_DDS_CORE22_FREQ_SLOPE           604022l
#define SPC_DDS_CORE23_FREQ_SLOPE           604023l
#define SPC_DDS_CORE24_FREQ_SLOPE           604024l
#define SPC_DDS_CORE25_FREQ_SLOPE           604025l
#define SPC_DDS_CORE26_FREQ_SLOPE           604026l
#define SPC_DDS_CORE27_FREQ_SLOPE           604027l
#define SPC_DDS_CORE28_FREQ_SLOPE           604028l
#define SPC_DDS_CORE29_FREQ_SLOPE           604029l
#define SPC_DDS_CORE30_FREQ_SLOPE           604030l
#define SPC_DDS_CORE31_FREQ_SLOPE           604031l
#define SPC_DDS_CORE32_FREQ_SLOPE           604032l
#define SPC_DDS_CORE33_FREQ_SLOPE           604033l
#define SPC_DDS_CORE34_FREQ_SLOPE           604034l
#define SPC_DDS_CORE35_FREQ_SLOPE           604035l
#define SPC_DDS_CORE36_FREQ_SLOPE           604036l
#define SPC_DDS_CORE37_FREQ_SLOPE           604037l
#define SPC_DDS_CORE38_FREQ_SLOPE           604038l
#define SPC_DDS_CORE39_FREQ_SLOPE           604039l
#define SPC_DDS_CORE40_FREQ_SLOPE           604040l
#define SPC_DDS_CORE41_FREQ_SLOPE           604041l
#define SPC_DDS_CORE42_FREQ_SLOPE           604042l
#define SPC_DDS_CORE43_FREQ_SLOPE           604043l
#define SPC_DDS_CORE44_FREQ_SLOPE           604044l
#define SPC_DDS_CORE45_FREQ_SLOPE           604045l
#define SPC_DDS_CORE46_FREQ_SLOPE           604046l
#define SPC_DDS_CORE47_FREQ_SLOPE           604047l
#define SPC_DDS_CORE48_FREQ_SLOPE           604048l
#define SPC_DDS_CORE49_FREQ_SLOPE           604049l
#define SPC_DDS_CORE50_FREQ_SLOPE           604050l
#define SPC_DDS_CORE51_FREQ_SLOPE           604051l
#define SPC_DDS_CORE52_FREQ_SLOPE           604052l
#define SPC_DDS_CORE53_FREQ_SLOPE           604053l
#define SPC_DDS_CORE54_FREQ_SLOPE           604054l
#define SPC_DDS_CORE55_FREQ_SLOPE           604055l
#define SPC_DDS_CORE56_FREQ_SLOPE           604056l
#define SPC_DDS_CORE57_FREQ_SLOPE           604057l
#define SPC_DDS_CORE58_FREQ_SLOPE           604058l
#define SPC_DDS_CORE59_FREQ_SLOPE           604059l
#define SPC_DDS_CORE60_FREQ_SLOPE           604060l
#define SPC_DDS_CORE61_FREQ_SLOPE           604061l
#define SPC_DDS_CORE62_FREQ_SLOPE           604062l
#define SPC_DDS_CORE63_FREQ_SLOPE           604063l

#define SPC_DDS_CORE0_AMP                   605000l
#define SPC_DDS_CORE1_AMP                   605001l
#define SPC_DDS_CORE2_AMP                   605002l
#define SPC_DDS_CORE3_AMP                   605003l
#define SPC_DDS_CORE4_AMP                   605004l
#define SPC_DDS_CORE5_AMP                   605005l
#define SPC_DDS_CORE6_AMP                   605006l
#define SPC_DDS_CORE7_AMP                   605007l
#define SPC_DDS_CORE8_AMP                   605008l
#define SPC_DDS_CORE9_AMP                   605009l
#define SPC_DDS_CORE10_AMP                  605010l
#define SPC_DDS_CORE11_AMP                  605011l
#define SPC_DDS_CORE12_AMP                  605012l
#define SPC_DDS_CORE13_AMP                  605013l
#define SPC_DDS_CORE14_AMP                  605014l
#define SPC_DDS_CORE15_AMP                  605015l
#define SPC_DDS_CORE16_AMP                  605016l
#define SPC_DDS_CORE17_AMP                  605017l
#define SPC_DDS_CORE18_AMP                  605018l
#define SPC_DDS_CORE19_AMP                  605019l
#define SPC_DDS_CORE20_AMP                  605020l
#define SPC_DDS_CORE21_AMP                  605021l
#define SPC_DDS_CORE22_AMP                  605022l
#define SPC_DDS_CORE23_AMP                  605023l
#define SPC_DDS_CORE24_AMP                  605024l
#define SPC_DDS_CORE25_AMP                  605025l
#define SPC_DDS_CORE26_AMP                  605026l
#define SPC_DDS_CORE27_AMP                  605027l
#define SPC_DDS_CORE28_AMP                  605028l
#define SPC_DDS_CORE29_AMP                  605029l
#define SPC_DDS_CORE30_AMP                  605030l
#define SPC_DDS_CORE31_AMP                  605031l
#define SPC_DDS_CORE32_AMP                  605032l
#define SPC_DDS_CORE33_AMP                  605033l
#define SPC_DDS_CORE34_AMP                  605034l
#define SPC_DDS_CORE35_AMP                  605035l
#define SPC_DDS_CORE36_AMP                  605036l
#define SPC_DDS_CORE37_AMP                  605037l
#define SPC_DDS_CORE38_AMP                  605038l
#define SPC_DDS_CORE39_AMP                  605039l
#define SPC_DDS_CORE40_AMP                  605040l
#define SPC_DDS_CORE41_AMP                  605041l
#define SPC_DDS_CORE42_AMP                  605042l
#define SPC_DDS_CORE43_AMP                  605043l
#define SPC_DDS_CORE44_AMP                  605044l
#define SPC_DDS_CORE45_AMP                  605045l
#define SPC_DDS_CORE46_AMP                  605046l
#define SPC_DDS_CORE47_AMP                  605047l
#define SPC_DDS_CORE48_AMP                  605048l
#define SPC_DDS_CORE49_AMP                  605049l
#define SPC_DDS_CORE50_AMP                  605050l
#define SPC_DDS_CORE51_AMP                  605051l
#define SPC_DDS_CORE52_AMP                  605052l
#define SPC_DDS_CORE53_AMP                  605053l
#define SPC_DDS_CORE54_AMP                  605054l
#define SPC_DDS_CORE55_AMP                  605055l
#define SPC_DDS_CORE56_AMP                  605056l
#define SPC_DDS_CORE57_AMP                  605057l
#define SPC_DDS_CORE58_AMP                  605058l
#define SPC_DDS_CORE59_AMP                  605059l
#define SPC_DDS_CORE60_AMP                  605060l
#define SPC_DDS_CORE61_AMP                  605061l
#define SPC_DDS_CORE62_AMP                  605062l
#define SPC_DDS_CORE63_AMP                  605063l

#define SPC_DDS_CORE0_AMP_SLOPE             606000l
#define SPC_DDS_CORE1_AMP_SLOPE             606001l
#define SPC_DDS_CORE2_AMP_SLOPE             606002l
#define SPC_DDS_CORE3_AMP_SLOPE             606003l
#define SPC_DDS_CORE4_AMP_SLOPE             606004l
#define SPC_DDS_CORE5_AMP_SLOPE             606005l
#define SPC_DDS_CORE6_AMP_SLOPE             606006l
#define SPC_DDS_CORE7_AMP_SLOPE             606007l
#define SPC_DDS_CORE8_AMP_SLOPE             606008l
#define SPC_DDS_CORE9_AMP_SLOPE             606009l
#define SPC_DDS_CORE10_AMP_SLOPE            606010l
#define SPC_DDS_CORE11_AMP_SLOPE            606011l
#define SPC_DDS_CORE12_AMP_SLOPE            606012l
#define SPC_DDS_CORE13_AMP_SLOPE            606013l
#define SPC_DDS_CORE14_AMP_SLOPE            606014l
#define SPC_DDS_CORE15_AMP_SLOPE            606015l
#define SPC_DDS_CORE16_AMP_SLOPE            606016l
#define SPC_DDS_CORE17_AMP_SLOPE            606017l
#define SPC_DDS_CORE18_AMP_SLOPE            606018l
#define SPC_DDS_CORE19_AMP_SLOPE            606019l
#define SPC_DDS_CORE20_AMP_SLOPE            606020l
#define SPC_DDS_CORE21_AMP_SLOPE            606021l
#define SPC_DDS_CORE22_AMP_SLOPE            606022l
#define SPC_DDS_CORE23_AMP_SLOPE            606023l
#define SPC_DDS_CORE24_AMP_SLOPE            606024l
#define SPC_DDS_CORE25_AMP_SLOPE            606025l
#define SPC_DDS_CORE26_AMP_SLOPE            606026l
#define SPC_DDS_CORE27_AMP_SLOPE            606027l
#define SPC_DDS_CORE28_AMP_SLOPE            606028l
#define SPC_DDS_CORE29_AMP_SLOPE            606029l
#define SPC_DDS_CORE30_AMP_SLOPE            606030l
#define SPC_DDS_CORE31_AMP_SLOPE            606031l
#define SPC_DDS_CORE32_AMP_SLOPE            606032l
#define SPC_DDS_CORE33_AMP_SLOPE            606033l
#define SPC_DDS_CORE34_AMP_SLOPE            606034l
#define SPC_DDS_CORE35_AMP_SLOPE            606035l
#define SPC_DDS_CORE36_AMP_SLOPE            606036l
#define SPC_DDS_CORE37_AMP_SLOPE            606037l
#define SPC_DDS_CORE38_AMP_SLOPE            606038l
#define SPC_DDS_CORE39_AMP_SLOPE            606039l
#define SPC_DDS_CORE40_AMP_SLOPE            606040l
#define SPC_DDS_CORE41_AMP_SLOPE            606041l
#define SPC_DDS_CORE42_AMP_SLOPE            606042l
#define SPC_DDS_CORE43_AMP_SLOPE            606043l
#define SPC_DDS_CORE44_AMP_SLOPE            606044l
#define SPC_DDS_CORE45_AMP_SLOPE            606045l
#define SPC_DDS_CORE46_AMP_SLOPE            606046l
#define SPC_DDS_CORE47_AMP_SLOPE            606047l
#define SPC_DDS_CORE48_AMP_SLOPE            606048l
#define SPC_DDS_CORE49_AMP_SLOPE            606049l
#define SPC_DDS_CORE50_AMP_SLOPE            606050l
#define SPC_DDS_CORE51_AMP_SLOPE            606051l
#define SPC_DDS_CORE52_AMP_SLOPE            606052l
#define SPC_DDS_CORE53_AMP_SLOPE            606053l
#define SPC_DDS_CORE54_AMP_SLOPE            606054l
#define SPC_DDS_CORE55_AMP_SLOPE            606055l
#define SPC_DDS_CORE56_AMP_SLOPE            606056l
#define SPC_DDS_CORE57_AMP_SLOPE            606057l
#define SPC_DDS_CORE58_AMP_SLOPE            606058l
#define SPC_DDS_CORE59_AMP_SLOPE            606059l
#define SPC_DDS_CORE60_AMP_SLOPE            606060l
#define SPC_DDS_CORE61_AMP_SLOPE            606061l
#define SPC_DDS_CORE62_AMP_SLOPE            606062l
#define SPC_DDS_CORE63_AMP_SLOPE            606063l

#define SPC_DDS_CORE0_PHASE                 607000l
#define SPC_DDS_CORE1_PHASE                 607001l
#define SPC_DDS_CORE2_PHASE                 607002l
#define SPC_DDS_CORE3_PHASE                 607003l
#define SPC_DDS_CORE4_PHASE                 607004l
#define SPC_DDS_CORE5_PHASE                 607005l
#define SPC_DDS_CORE6_PHASE                 607006l
#define SPC_DDS_CORE7_PHASE                 607007l
#define SPC_DDS_CORE8_PHASE                 607008l
#define SPC_DDS_CORE9_PHASE                 607009l
#define SPC_DDS_CORE10_PHASE                607010l
#define SPC_DDS_CORE11_PHASE                607011l
#define SPC_DDS_CORE12_PHASE                607012l
#define SPC_DDS_CORE13_PHASE                607013l
#define SPC_DDS_CORE14_PHASE                607014l
#define SPC_DDS_CORE15_PHASE                607015l
#define SPC_DDS_CORE16_PHASE                607016l
#define SPC_DDS_CORE17_PHASE                607017l
#define SPC_DDS_CORE18_PHASE                607018l
#define SPC_DDS_CORE19_PHASE                607019l
#define SPC_DDS_CORE20_PHASE                607020l
#define SPC_DDS_CORE21_PHASE                607021l
#define SPC_DDS_CORE22_PHASE                607022l
#define SPC_DDS_CORE23_PHASE                607023l
#define SPC_DDS_CORE24_PHASE                607024l
#define SPC_DDS_CORE25_PHASE                607025l
#define SPC_DDS_CORE26_PHASE                607026l
#define SPC_DDS_CORE27_PHASE                607027l
#define SPC_DDS_CORE28_PHASE                607028l
#define SPC_DDS_CORE29_PHASE                607029l
#define SPC_DDS_CORE30_PHASE                607030l
#define SPC_DDS_CORE31_PHASE                607031l
#define SPC_DDS_CORE32_PHASE                607032l
#define SPC_DDS_CORE33_PHASE                607033l
#define SPC_DDS_CORE34_PHASE                607034l
#define SPC_DDS_CORE35_PHASE                607035l
#define SPC_DDS_CORE36_PHASE                607036l
#define SPC_DDS_CORE37_PHASE                607037l
#define SPC_DDS_CORE38_PHASE                607038l
#define SPC_DDS_CORE39_PHASE                607039l
#define SPC_DDS_CORE40_PHASE                607040l
#define SPC_DDS_CORE41_PHASE                607041l
#define SPC_DDS_CORE42_PHASE                607042l
#define SPC_DDS_CORE43_PHASE                607043l
#define SPC_DDS_CORE44_PHASE                607044l
#define SPC_DDS_CORE45_PHASE                607045l
#define SPC_DDS_CORE46_PHASE                607046l
#define SPC_DDS_CORE47_PHASE                607047l
#define SPC_DDS_CORE48_PHASE                607048l
#define SPC_DDS_CORE49_PHASE                607049l
#define SPC_DDS_CORE50_PHASE                607050l
#define SPC_DDS_CORE51_PHASE                607051l
#define SPC_DDS_CORE52_PHASE                607052l
#define SPC_DDS_CORE53_PHASE                607053l
#define SPC_DDS_CORE54_PHASE                607054l
#define SPC_DDS_CORE55_PHASE                607055l
#define SPC_DDS_CORE56_PHASE                607056l
#define SPC_DDS_CORE57_PHASE                607057l
#define SPC_DDS_CORE58_PHASE                607058l
#define SPC_DDS_CORE59_PHASE                607059l
#define SPC_DDS_CORE60_PHASE                607060l
#define SPC_DDS_CORE61_PHASE                607061l
#define SPC_DDS_CORE62_PHASE                607062l
#define SPC_DDS_CORE63_PHASE                607063l

#define SPC_DDS_TRG_SRC                     608000l
#define     SPCM_DDS_TRG_SRC_NONE               0
#define     SPCM_DDS_TRG_SRC_TIMER              1
#define     SPCM_DDS_TRG_SRC_CARD               2
// set XIO with register below

#define SPC_DDS_TRG_TIMER                   608001l

#define SPC_DDS_PHASE_BEHAVIOUR             608002l
#define     SPCM_DDS_PHASE_JUMP                 0
#define     SPCM_DDS_PHASE_SHIFT                1

#define SPC_DDS_CMD                         608003l
#define     SPCM_DDS_CMD_RESET                  0x01
#define     SPCM_DDS_CMD_EXEC_AT_TRG            0x02
#define     SPCM_DDS_CMD_EXEC_NOW               0x04
#define     SPCM_DDS_CMD_WRITE_TO_CARD          0x08
#define     SPCM_DDS_CMD_NO_NOP_FILL            0x10

#define SPC_DDS_STATUS                      608004l // read-only
#define     SPCM_DDS_STAT_WAITING_FOR_TRG       0x01
#define     SPCM_DDS_STAT_QUEUE_UNDERRUN        0x02
#define     SPCM_DDS_STAT_QUEUE_OVERRUN         0x04

#define SPC_DDS_QUEUE_CMD_MAX               608005l // read-only
#define SPC_DDS_QUEUE_CMD_COUNT             608006l // read-only
#define SPC_DDS_NUM_CORES                   608007l // read-only

#define SPC_DDS_FREQ_RAMP_STEPSIZE          608008l
#define SPC_DDS_AMP_RAMP_STEPSIZE           608009l

#define SPC_DDS_X_MANUAL_OUTPUT             608010l
#define     SPCM_DDS_X0                         0x1
#define     SPCM_DDS_X1                         0x2
#define     SPCM_DDS_X2                         0x4
#define     SPCM_DDS_X3                         0x8

#define SPC_DDS_NUM_QUEUED_CMD_IN_SW        608011l // read-only

#define SPC_DDS_DATA_TRANSFER_MODE          608012l
#define     SPCM_DDS_DTM_SINGLE                 0
#define     SPCM_DDS_DTM_DMA                    1

#define SPC_DDS_TRG_COUNT                   608013l // read-only

#define SPC_DDS_CORES_ON_CH0                608040l
#define SPC_DDS_CORES_ON_CH1                608041l
#define SPC_DDS_CORES_ON_CH2                608042l
#define SPC_DDS_CORES_ON_CH3                608043l
#define     SPCM_DDS_CORE_NONE                  0x0000000000000000ULL
#define     SPCM_DDS_CORE0                      0x0000000000000001ULL
#define     SPCM_DDS_CORE1                      0x0000000000000002ULL
#define     SPCM_DDS_CORE2                      0x0000000000000004ULL
#define     SPCM_DDS_CORE3                      0x0000000000000008ULL
#define     SPCM_DDS_CORE4                      0x0000000000000010ULL
#define     SPCM_DDS_CORE5                      0x0000000000000020ULL
#define     SPCM_DDS_CORE6                      0x0000000000000040ULL
#define     SPCM_DDS_CORE7                      0x0000000000000080ULL
#define     SPCM_DDS_CORE8                      0x0000000000000100ULL
#define     SPCM_DDS_CORE9                      0x0000000000000200ULL
#define     SPCM_DDS_CORE10                     0x0000000000000400ULL
#define     SPCM_DDS_CORE11                     0x0000000000000800ULL
#define     SPCM_DDS_CORE12                     0x0000000000001000ULL
#define     SPCM_DDS_CORE13                     0x0000000000002000ULL
#define     SPCM_DDS_CORE14                     0x0000000000004000ULL
#define     SPCM_DDS_CORE15                     0x0000000000008000ULL
#define     SPCM_DDS_CORE16                     0x0000000000010000ULL
#define     SPCM_DDS_CORE17                     0x0000000000020000ULL
#define     SPCM_DDS_CORE18                     0x0000000000040000ULL
#define     SPCM_DDS_CORE19                     0x0000000000080000ULL
#define     SPCM_DDS_CORE20                     0x0000000000100000ULL
#define     SPCM_DDS_CORE21                     0x0000000000200000ULL
#define     SPCM_DDS_CORE22                     0x0000000000400000ULL
#define     SPCM_DDS_CORE23                     0x0000000000800000ULL
#define     SPCM_DDS_CORE24                     0x0000000001000000ULL
#define     SPCM_DDS_CORE25                     0x0000000002000000ULL
#define     SPCM_DDS_CORE26                     0x0000000004000000ULL
#define     SPCM_DDS_CORE27                     0x0000000008000000ULL
#define     SPCM_DDS_CORE28                     0x0000000010000000ULL
#define     SPCM_DDS_CORE29                     0x0000000020000000ULL
#define     SPCM_DDS_CORE30                     0x0000000040000000ULL
#define     SPCM_DDS_CORE31                     0x0000000080000000ULL
#define     SPCM_DDS_CORE32                     0x0000000100000000ULL
#define     SPCM_DDS_CORE33                     0x0000000200000000ULL
#define     SPCM_DDS_CORE34                     0x0000000400000000ULL
#define     SPCM_DDS_CORE35                     0x0000000800000000ULL
#define     SPCM_DDS_CORE36                     0x0000001000000000ULL
#define     SPCM_DDS_CORE37                     0x0000002000000000ULL
#define     SPCM_DDS_CORE38                     0x0000004000000000ULL
#define     SPCM_DDS_CORE39                     0x0000008000000000ULL
#define     SPCM_DDS_CORE40                     0x0000010000000000ULL
#define     SPCM_DDS_CORE41                     0x0000020000000000ULL
#define     SPCM_DDS_CORE42                     0x0000040000000000ULL
#define     SPCM_DDS_CORE43                     0x0000080000000000ULL
#define     SPCM_DDS_CORE44                     0x0000100000000000ULL
#define     SPCM_DDS_CORE45                     0x0000200000000000ULL
#define     SPCM_DDS_CORE46                     0x0000400000000000ULL
#define     SPCM_DDS_CORE47                     0x0000800000000000ULL
#define     SPCM_DDS_CORE48                     0x0001000000000000ULL
#define     SPCM_DDS_CORE49                     0x0002000000000000ULL
#define     SPCM_DDS_CORE50                     0x0004000000000000ULL
#define     SPCM_DDS_CORE51                     0x0008000000000000ULL
#define     SPCM_DDS_CORE52                     0x0010000000000000ULL
#define     SPCM_DDS_CORE53                     0x0020000000000000ULL
#define     SPCM_DDS_CORE54                     0x0040000000000000ULL
#define     SPCM_DDS_CORE55                     0x0080000000000000ULL
#define     SPCM_DDS_CORE56                     0x0100000000000000ULL
#define     SPCM_DDS_CORE57                     0x0200000000000000ULL
#define     SPCM_DDS_CORE58                     0x0400000000000000ULL
#define     SPCM_DDS_CORE59                     0x0800000000000000ULL
#define     SPCM_DDS_CORE60                     0x1000000000000000ULL
#define     SPCM_DDS_CORE61                     0x2000000000000000ULL
#define     SPCM_DDS_CORE62                     0x4000000000000000ULL
#define     SPCM_DDS_CORE63                     0x8000000000000000ULL

#define SPC_DDS_X0_MODE                     608060l
#define SPC_DDS_X1_MODE                     608061l
#define SPC_DDS_X2_MODE                     608062l
#define SPC_DDS_X3_MODE                     608063l
//          NONE                                     is not needed because one can simply switch off the XMODE
#define     SPCM_DDS_XMODE_MANUAL               1
#define     SPCM_DDS_XMODE_WAITING_FOR_TRG      2
#define     SPCM_DDS_XMODE_EXEC                 3


#define SPC_DDS_AVAIL_FREQ_MIN              608500l
#define SPC_DDS_AVAIL_FREQ_MAX              608501l
#define SPC_DDS_AVAIL_FREQ_STEP             608502l

#define SPC_DDS_AVAIL_FREQ_SLOPE_MIN        608503l
#define SPC_DDS_AVAIL_FREQ_SLOPE_MAX        608504l
#define SPC_DDS_AVAIL_FREQ_SLOPE_STEP       608505l

#define SPC_DDS_AVAIL_AMP_MIN               608506l
#define SPC_DDS_AVAIL_AMP_MAX               608507l
#define SPC_DDS_AVAIL_AMP_STEP              608508l

#define SPC_DDS_AVAIL_AMP_SLOPE_MIN         608509l
#define SPC_DDS_AVAIL_AMP_SLOPE_MAX         608510l
#define SPC_DDS_AVAIL_AMP_SLOPE_STEP        608511l

#define SPC_DDS_AVAIL_PHASE_MIN             608512l
#define SPC_DDS_AVAIL_PHASE_MAX             608513l
#define SPC_DDS_AVAIL_PHASE_STEP            608514l
