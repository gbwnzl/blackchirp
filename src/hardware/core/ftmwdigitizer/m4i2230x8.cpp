...
M4i2230x8::M4i2230x8(QObject *parent) :
    FtmwScope(BC::Key::FtmwScope::m4i2230x8,BC::Key::FtmwScope::m4i2230x8Name,CommunicationProtocol::Custom,parent), p_handle(nullptr)
{
...
void M4i2230x8::initialize()
{
    p_timer = new QTimer(this);
}

bool M4i2230x8::prepareForExperiment(Experiment &exp)
{
    if(!exp.ftmwEnabled())
    {
...
void M4i2230x8::beginAcquisition()
{
    if(d_enabledForExperiment)
    {
        ...
        connect(p_timer,&QTimer::timeout,this,&M4i2230x8::readWaveform,Qt::UniqueConnection);
        p_timer->start(100);
    }
}

void M4i2230x8::endAcquisition()
{
    if(d_enabledForExperiment)
    {
        p_timer->stop();
        disconnect(p_timer,&QTimer::timeout,this,&M4i2230x8::readWaveform);
